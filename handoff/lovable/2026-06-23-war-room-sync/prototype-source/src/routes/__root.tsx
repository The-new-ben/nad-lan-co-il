...
import { SiteHeader } from "@/components/nadlan/SiteHeader";
import { SiteFooter } from "@/components/nadlan/SiteFooter";
      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex justify-center gap-2">
          <button
            ...
            className="rounded-sm bg-foreground px-4 py-2 text-sm text-background hover:bg-foreground/90"
          >
            Try again
          </button>
          <a href="/" className="hairline rounded-sm px-4 py-2 text-sm">Go home</a>
        </div>
      </div>
    </div>
  );
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Nadlan3D",
          url: "/",
          slogan: "Real Estate, Rendered Real",
        }),
      },
    ],
  }),
