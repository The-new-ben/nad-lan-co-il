...
T = {
 'he': dict(
    ...
    eyebrow='כרטיס מתווכת · nad-lan', name='מיטל קציר', brand='נדל״ן על הים',
    ...
    f_lead='כ-700 מ״ר בנויים בשלושה מפלסים על מגרש של כ-1,100 מ״ר, במרחק הליכה מהים וכחמש דקות מכיכר דה שליט, לפי המשווקת.',
    ...
    method=[('כל מספר עם מקור', 'נתוני הנכס מסומנים כנתוני המשווקת, והנתונים מסביב מקושרים למקור ציבורי.'),
    ...
    legal='העמוד הוכן על ידי nad-lan.co.il בשיתוף המשווקת. המידע נאסף ממודעות המשווקת ומפרסומים ציבוריים ונכון ל-16.9.2026. אין בו הצעה מחייבת, שמאות או ייעוץ. תמונות: מיטל קציר, נדל״ן על הים.',
    ...
    share_kicker='nad-lan · כרטיס מתווכת', share_stats=[('11', 'נכסים בבלעדיות'), ('6', 'שכונות על קו החוף')], share_url='nad-lan.co.il/brokers/meital-katzir',
