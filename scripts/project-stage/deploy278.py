"""Release 1.72.278 (25.9.2026): Rainbow, the floor answers (the site loop R7; design system version 33; Linear HAD-221).
The owner, after trying floor 32: a floor click must show the direction with the beam, link the building and the map, give
cards with information and let the buyer get inside, design the apartment and see the view; the map attached under the model.

  assets/project-stage/rainbow/stage.js   autoFacing (the first tap picks the floor's sea-side example apartment, so the
                                          view and the beam answer at once) and the floor card's actions (nl:floor-action)
  assets/project-stage/rainbow/stage.css  the card at 264px, its actions, the "לצד אחר" line
  assets/project-stage/bridge.js          the actions: inside (the viewer on the nearest rendered floor), the view and the
                                          map, the designer; the steps under the stage; the sea side first
  inc/project-stage.php                   the view and the map right under the stage on every width; the steps replace
                                          the hint; the inside views on floors 10, 25 and 36
  assets/nlds/nlds.css                    the steps (built from the design system v33)
  assets/project-stage/rainbow/tour/*-10?.jpg, *-36?.jpg (+ -2k)   32 new inside views (Blender, scripts/interior/render_floors.py)
  nadlan-config.php                       version bump, on the LIVE text

Same safety chain as deploy277.py. The app password is decrypted in-process (DPAPI), never printed.
  python scripts/project-stage/deploy278.py [--dry | --rollback]
"""
...
UA = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) NadLan-PS278/1.0"
...
NS = 'nadlan-ps278-' + TOKEN[:8]  # one route per run: a bridge left over from a failed run can never answer for this one
BRIDGE = r'''
...
def bridge_up():
    global BR
    s, c = snip("POST", "", {"name": f"x-tmp-ps278-ops-{int(time.time())}", "code": BRIDGE, "scope": "global", "active": False})
...
def rollback(created_any):
    print("[rollback] restoring .bak278 files")
...
# ---------------------------------------------------------------- main
NEWFILES = set(['assets/project-stage/rainbow/tour/balcony-10e-2k.jpg', 'assets/project-stage/rainbow/tour/balcony-10e.jpg', 'assets/project-stage/rainbow/tour/balcony-10n-2k.jpg', 'assets/project-stage/rainbow/tour/balcony-10n.jpg', 'assets/project-stage/rainbow/tour/balcony-10s-2k.jpg', 'assets/project-stage/rainbow/tour/balcony-10s.jpg', 'assets/project-stage/rainbow/tour/balcony-10w-2k.jpg', 'assets/project-stage/rainbow/tour/balcony-10w.jpg', 'assets/project-stage/rainbow/tour/balcony-36e-2k.jpg', 'assets/project-stage/rainbow/tour/balcony-36e.jpg', 'assets/project-stage/rainbow/tour/balcony-36n-2k.jpg', 'assets/project-stage/rainbow/tour/balcony-36n.jpg', 'assets/project-stage/rainbow/tour/balcony-36s-2k.jpg', 'assets/project-stage/rainbow/tour/balcony-36s.jpg', 'assets/project-stage/rainbow/tour/balcony-36w-2k.jpg', 'assets/project-stage/rainbow/tour/balcony-36w.jpg', 'assets/project-stage/rainbow/tour/living-10e-2k.jpg', 'assets/project-stage/rainbow/tour/living-10e.jpg', 'assets/project-stage/rainbow/tour/living-10n-2k.jpg', 'assets/project-stage/rainbow/tour/living-10n.jpg', 'assets/project-stage/rainbow/tour/living-10s-2k.jpg', 'assets/project-stage/rainbow/tour/living-10s.jpg', 'assets/project-stage/rainbow/tour/living-10w-2k.jpg', 'assets/project-stage/rainbow/tour/living-10w.jpg', 'assets/project-stage/rainbow/tour/living-36e-2k.jpg', 'assets/project-stage/rainbow/tour/living-36e.jpg', 'assets/project-stage/rainbow/tour/living-36n-2k.jpg', 'assets/project-stage/rainbow/tour/living-36n.jpg', 'assets/project-stage/rainbow/tour/living-36s-2k.jpg', 'assets/project-stage/rainbow/tour/living-36s.jpg', 'assets/project-stage/rainbow/tour/living-36w-2k.jpg', 'assets/project-stage/rainbow/tour/living-36w.jpg'])
FILES = ["assets/project-stage/rainbow/stage.js", "assets/project-stage/rainbow/stage.css", "assets/project-stage/bridge.js", "inc/project-stage.php", "assets/nlds/nlds.css"] + sorted(NEWFILES)
...
try:
    ...
    for rel in FILES:
        ...
        prev = None
        for res in ("project-stage-2026-09-24/deploy-result-277.json", "project-stage-2026-09-24/deploy-result-276.json", "project-stage-2026-09-24/deploy-result-275.json", "project-stage-2026-09-24/deploy-result-274.json", "project-stage-2026-09-24/deploy-result-273.json", "project-stage-2026-09-24/deploy-result-272.json", "project-stage-2026-09-24/deploy-result-271.json", "project-stage-2026-09-24/deploy-result-270.json", "project-stage-2026-09-24/deploy-result-269.json", "project-stage-2026-09-24/deploy-result-268.json", "project-stage-2026-09-24/deploy-result-267.json", "project-stage-2026-09-24/deploy-result-266.json", "project-stage-2026-09-24/deploy-result-265.json", "project-stage-2026-09-24/deploy-result-264.json", "project-stage-2026-09-24/deploy-result-263.json", "project-stage-2026-09-24/deploy-result-262.json", "project-stage-2026-09-24/deploy-result-261.json", "project-stage-2026-09-24/deploy-result-260.json", "project-stage-2026-09-24/deploy-result-259.json", "project-stage-2026-09-24/deploy-result-258.json", "recommendations-2026-09-24/deploy-result-257.json", "project-stage-2026-09-24/deploy-result-256.json", "project-stage-2026-09-24/deploy-result-255.json", "firgun-2026-09-24/deploy-result-251.json", "tour-calendar-2026-09-24/deploy-result-248.json", "profile-emoji-2026-09-24/deploy-result-250.json", "broker-video-2026-09-24/deploy-result-249.json", "tour-calendar-2026-09-24/deploy-result-248.json", "wa-pill-2026-09-24/deploy-result-247.json", "placements-2026-09-24/deploy-result-246.json"):
    ...
    bad = verify_pages("ps278" + str(int(time.time()))) if healthy else ["health"]
    if healthy and not bad and not verify_order("ps278o" + str(int(time.time()))):
        bad = ["order"]
    if healthy and not bad and not verify_home_order("ps278h" + str(int(time.time()))):
        bad = ["home-order"]
    ...
    if bad:
        ...
        bad = verify_pages("ps278b" + str(int(time.time()))) if healthy else ["health"]
        if healthy and not bad and not verify_order("ps278p" + str(int(time.time()))):
            bad = ["order"]
        if healthy and not bad and not verify_home_order("ps278q" + str(int(time.time()))):
            bad = ["home-order"]
    if bad:
    ...
    json.dump({"released": new, "from": old, "at": time.strftime("%Y-%m-%d %H:%M:%S"),
        ...
        open(os.path.join(QA, "deploy-result-278.json"), "w", encoding="utf-8"), indent=2)
    json.dump({"before": before, "after": after}, open(os.path.join(QA, "speed-278.json"), "w", encoding="utf-8"), indent=2)
