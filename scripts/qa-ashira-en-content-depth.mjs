...
const PATTERN = 'patterns/project-showroom-ashira-v2-en.php';
const DRAFT = 'docs/wp-drafts/ashira-sde-dov-en-v2-draft.json';
const OUT = 'docs/qa/ashira-en-content-depth-report.json';
...
const failures = [];
const banned = /(SEO|CMS|CRM|lead|leads|engine|template|prototype|project manager|supplier|contractor|internal|strategy|factory|fallback|placeholder|mock|monetization|פאנל|מנוע|תבנית|לידים|משפך|מוניטיז|אסטרטג|מקום שמור|Codex|Claude)/i;
...
if (!pattern.includes('Sources and reliability notes')) failures.push('pattern missing sources section');
...
if (/[\u0590-\u05ff]/.test(visible)) failures.push('English page visible text contains Hebrew characters');
