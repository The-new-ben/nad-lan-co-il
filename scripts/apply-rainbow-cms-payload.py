...
def build_rest_meta(source: dict[str, Any], *, include_units: bool = False) -> dict[str, str]:
    ...
    meta = {
        ...
        "project_3d_video_url": str(source.get("project_3d_video_url", "")),
        "project_3d_tour_url": str(source.get("project_3d_tour_url", "")),
        "project_3d_cesium_tiles_url": str(source.get("project_3d_cesium_tiles_url", "")),
