...
/* Single source of truth for asset cache-busting. MUST match the header Version
...
if ( ! defined( 'NADLAN_CONFIG_VERSION' ) ) {
	define( 'NADLAN_CONFIG_VERSION', '1.72.279' );
}
