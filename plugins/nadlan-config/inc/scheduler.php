...
if ( ! function_exists( 'nadlan_sched_strings' ) ) {
	function nadlan_sched_strings( $lang = 'he' ) {
		$he = array(
			'kicker'     => 'תיאום מועד',
			'title_tour' => 'קביעת סיור בפרויקט', 'title_visit' => 'תיאום ביקור בנכס', 'title_meeting' => 'קביעת פגישת ייעוץ',
			'sub'        => 'בוחרים יום ושעה פנויים ביומן ומקבלים אישור מיידי. ללא תשלום וללא התחייבות.',
			...
			'submit'     => 'אישור המועד', 'sending' => 'קובעים את המועד...',
			'ok_title'   => 'המועד נקבע', 'ok_sub' => 'שמרנו לכם את המועד ביומן. אסמכתא:',
			'wa_btn'     => 'שליחת אישור בוואטסאפ', 'ics_btn' => 'הוספה ליומן (ICS)', 'gcal_btn' => 'יומן Google',
			...
			'wa_text'    => 'שלום, קבעתי {kind} - {card} בתאריך {date} בשעה {time}. שם: {name}. אסמכתא: {ref}',
			'kind_tour'  => 'סיור בפרויקט', 'kind_visit' => 'ביקור בנכס', 'kind_meeting' => 'פגישת ייעוץ',
			'honest'     => 'המועד מאושר ביומן האתר. שינוי או ביטול - בכפתור הביטול או בוואטסאפ.',
		);
		$en = array(
			'kicker'     => 'Book a time',
			'title_tour' => 'Schedule a project tour', 'title_visit' => 'Schedule a property visit', 'title_meeting' => 'Book a consultation',
			'sub'        => 'Pick an open day and time on the calendar and get instant confirmation. Free, no commitment.',
			...
			'ok_title'   => 'Your appointment is set', 'ok_sub' => 'The time is saved on the calendar. Reference:',
			'wa_btn'     => 'Send WhatsApp confirmation', 'ics_btn' => 'Add to calendar (ICS)', 'gcal_btn' => 'Google Calendar',
			...
			'wa_text'    => 'Hello, I booked a {kind} - {card} on {date} at {time}. Name: {name}. Ref: {ref}',
			'kind_tour'  => 'project tour', 'kind_visit' => 'property visit', 'kind_meeting' => 'consultation',
			'honest'     => 'The time is confirmed on the site calendar. To change or cancel, use the cancel button or WhatsApp.',
		);
		$fr = array(
			'kicker'     => 'Prise de rendez-vous',
			'title_tour' => 'Planifier une visite du projet', 'title_visit' => 'Planifier une visite du bien', 'title_meeting' => 'Réserver une consultation',
			'sub'        => 'Choisissez un jour et une heure disponibles et recevez une confirmation immédiate. Gratuit et sans engagement.',
			...
			'ok_title'   => 'Rendez-vous confirmé', 'ok_sub' => 'Le créneau est enregistré. Référence:',
			...
			'wa_text'    => 'Bonjour, j’ai réservé {kind} - {card} le {date} à {time}. Nom: {name}. Réf: {ref}',
			'kind_tour'  => 'une visite du projet', 'kind_visit' => 'une visite du bien', 'kind_meeting' => 'une consultation',
			'honest'     => 'Le créneau est confirmé dans le calendrier du site. Pour modifier ou annuler: le bouton d’annulation ou WhatsApp.',
		);
		$ru = array(
			'kicker'     => 'Запись на встречу',
			'title_tour' => 'Записаться на экскурсию по проекту', 'title_visit' => 'Записаться на просмотр квартиры', 'title_meeting' => 'Записаться на консультацию',
			'sub'        => 'Выберите свободный день и время и получите мгновенное подтверждение. Бесплатно и без обязательств.',
			...
			'ok_title'   => 'Встреча назначена', 'ok_sub' => 'Время сохранено в календаре. Номер:',
			...
			'wa_text'    => 'Здравствуйте, я записался на {kind} - {card} {date} в {time}. Имя: {name}. Номер: {ref}',
			'kind_tour'  => 'экскурсию по проекту', 'kind_visit' => 'просмотр квартиры', 'kind_meeting' => 'консультацию',
			'honest'     => 'Время подтверждено в календаре сайта. Изменить или отменить: кнопка отмены или WhatsApp.',
		);
		$ar = array(
			'kicker'     => 'حجز موعد',
			'title_tour' => 'حجز جولة في المشروع', 'title_visit' => 'حجز زيارة للعقار', 'title_meeting' => 'حجز استشارة',
			'sub'        => 'اختاروا يوماً وساعة متاحين واحصلوا على تأكيد فوري. مجاناً وبدون التزام.',
			...
			'ok_title'   => 'تم تحديد الموعد', 'ok_sub' => 'تم حفظ الموعد في التقويم. رقم المرجع:',
			...
			'wa_text'    => 'مرحباً، حجزت {kind} - {card} بتاريخ {date} الساعة {time}. الاسم: {name}. المرجع: {ref}',
			'kind_tour'  => 'جولة في المشروع', 'kind_visit' => 'زيارة للعقار', 'kind_meeting' => 'استشارة',
			'honest'     => 'الموعد مؤكد في تقويم الموقع. للتغيير أو الإلغاء: زر الإلغاء أو واتساب.',
		);
