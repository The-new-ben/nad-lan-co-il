...
if ( ! function_exists( 'nadlan_i18n_table' ) ) {
	function nadlan_i18n_table() {
		...
		'he' => array(
			...
			'trust_calc' => 'מחשבונים מקצועיים', 'trust_law' => 'עורכי דין ואנשי מקצוע במאגר', 'trust_law_pre' => 'מאגר',
			'ur_kicker' => 'התחדשות עירונית', 'ur_title' => 'חדר הפרויקט של הבניין שלכם',
			'ur_sub' => 'מעקב הסכמות על מודל תלת-ממדי של הבניין, סרגל עשרת השלבים, מסמכים ועדכונים - הכל במקום פרטי אחד. חינם לדיירים ולנציגות.',
			'ur_step1' => 'בודקים את הבניין', 'ur_step2' => 'פותחים חדר', 'ur_step3' => 'מזמינים את השכנים',
			'ur_cta1' => 'בדיקת כדאיות חינם', 'ur_cta2' => 'לחדר הפרויקט + הדגמה חיה',
			'ur_note' => 'עברית · English · Русский · פרטי ולא מופיע בחיפוש',
			'rm_kicker' => 'ניהול השכרות · חינם', 'rm_title' => 'כל הדירות המושכרות שלכם: על המפה ובתוך הבניין',
			'rm_sub' => 'מוסיפים נכס, מסמנים את הדירות שלכם על מודל תלת-ממדי, וצבע הדירה אומר הכל: שולם, ממתין, בפיגור, פנויה. מעקב תשלומים, תזכורות חוזה ומס, מסמכים ותחזוקה - במקום אחד.',
			'rm_step1' => 'מוסיפים נכס', 'rm_step2' => 'מסמנים דירות על המודל', 'rm_step3' => 'רואים הכל בצבע אחד',
			'rm_cta' => 'מתחילים לנהל, חינם', 'rm_note' => 'מעקב ותזכורות, לא סליקה · פרטי ולא מופיע בחיפוש',
			...
			'rc_kicker' => 'מהמערכת', 'rc_title' => 'כדאי לדעת', 'rc_term' => 'מונח במילון', 'rc_tool' => 'כלי חישוב', 'rc_guide' => 'מדריך', 'rc_news' => 'חדשות', 'rc_calc_mortgage' => 'מחשבון משכנתא', 'rc_calc_ptax' => 'מחשבון מס רכישה', 'rc_guide_buy' => 'מדריך קניית דירה', 'rc_dossier_k' => 'רקע מקצועי', 'rc_dossier_t' => 'על התחום: מה חשוב לדעת', 'sh_chip' => 'הדגם התלת ממדי האמיתי של הפרויקט', 'sh_spin' => 'הקישו לסיבוב בתלת ממד', 'sh_floors' => 'קומות', 'fl_kicker' => 'החוויה המלאה', 'fl_title' => 'בחרו דירה מתוך הבניין, בתלת ממד', 'fl_sub' => 'פרויקטים אמיתיים שהפכנו למודלים חיים, כהדגמת יכולת: מסובבים את הבניין, בוחרים קומה וכיוון ורואים את הנוף. היזמים המוצגים אינם לקוחות שלנו - ככה פשוט ייראה כל פרויקט שעולה לבמה.', 'fl_dev' => 'יזמים: רוצים את הבניין שלכם על הבמה? דברו איתנו', 'fl_all' => 'לקטלוג התלת ממד ←', 'fl_go' => 'לסיור בפרויקט ←',
			// magazine band
		...
		'en' => array(
			...
			'trust_calc' => 'professional calculators', 'trust_law' => 'lawyers and professionals in the directory', 'trust_law_pre' => 'a vetted',
			'ur_kicker' => 'Urban renewal', 'ur_title' => 'Your building\'s renewal project room',
			'ur_sub' => 'Track every apartment\'s consent on a 3D model of the building, follow the 10 stages, keep documents and updates in one private place. Free for residents and committees.',
			'ur_step1' => 'Check your building', 'ur_step2' => 'Open a room', 'ur_step3' => 'Invite the neighbors',
			'ur_cta1' => 'Free feasibility check', 'ur_cta2' => 'The project room + live demo',
			'ur_note' => 'Hebrew · English · Russian · private, never shown in search',
			'rm_kicker' => 'Rental management · free', 'rm_title' => 'Every apartment you rent out: on the map, inside the building',
			'rm_sub' => 'Add a property, mark your apartments on a 3D model, and the color tells the story: paid, pending, late, vacant. Rent tracking, lease and tax reminders, documents and maintenance - one place.',
			'rm_step1' => 'Add a property', 'rm_step2' => 'Mark your apartments on the model', 'rm_step3' => 'See everything in one color',
			'rm_cta' => 'Start managing, free', 'rm_note' => 'Tracking and reminders, no payment processing · private, never in search',
			...
			'm_tours' => '3D Tours', 'tours_all' => 'All tours — one place', 'tour_sd' => 'Sde Dov quarter tour', 'tour_so' => 'Somail compound tour', 'tour_esd' => 'Sde Dov helicopter — real photo', 'tour_eso' => 'Somail helicopter', 'tour_des' => 'Apartment designer', 'prices_index' => 'Apartment prices — all cities',
			'tour_catalog' => 'The 3D catalog', 'guides_all' => 'All guides', 'nav_areas' => 'Hot areas', 'nav_global' => 'Global real estate',
			'cta_wa_b' => 'For more details', 'cta_wa_s' => 'Fast reply on WhatsApp', 'cta_wa_aria' => 'WhatsApp — for more details', 'cta_wa_msg' => 'Hi, I’d like more details.',
			...
			'rc_kicker' => 'From the platform', 'rc_title' => 'Worth knowing', 'rc_term' => 'Glossary term', 'rc_tool' => 'Calculator', 'rc_guide' => 'Guide', 'rc_news' => 'News', 'rc_calc_mortgage' => 'Mortgage calculator', 'rc_calc_ptax' => 'Purchase tax calculator', 'rc_guide_buy' => 'Apartment buying guide', 'rc_dossier_k' => 'Professional background', 'rc_dossier_t' => 'About the field: what to know', 'sh_chip' => 'The project\'s real 3D model', 'sh_spin' => 'Tap to spin in 3D', 'sh_floors' => 'floors', 'fl_kicker' => 'The full experience', 'fl_title' => 'Choose your apartment from inside the building, in 3D', 'fl_sub' => 'Real projects we turned into living models as a capability showcase: rotate the building, pick a floor and orientation, see the view. The developers shown are not our clients - this is simply how any project looks on our stage.', 'fl_dev' => 'Developers: want your building on this stage? Talk to us', 'fl_all' => 'Open the 3D catalog', 'fl_go' => 'Tour the project',
		...
		'fr' => array(
			...
			'trust_calc' => 'calculateurs professionnels', 'trust_law' => 'avocats et professionnels du repertoire', 'trust_law_pre' => 'un annuaire d',
			'ur_kicker' => 'Renouvellement urbain', 'ur_title' => 'La salle de projet de votre immeuble',
			'ur_sub' => 'Suivez le consentement de chaque appartement sur un modele 3D, les 10 etapes, les documents et les mises a jour - en un lieu prive. Gratuit pour les residents.',
			'ur_step1' => 'Verifiez votre immeuble', 'ur_step2' => 'Ouvrez une salle', 'ur_step3' => 'Invitez les voisins',
			'ur_cta1' => 'Verification gratuite', 'ur_cta2' => 'La salle de projet + demo en direct',
			'ur_note' => 'Hebreu · Anglais · Russe · prive, jamais indexe',
			'rm_kicker' => 'Gestion locative · gratuit', 'rm_title' => 'Chaque appartement loue: sur la carte, dans le batiment',
			'rm_sub' => 'Ajoutez un bien, marquez vos appartements sur un modele 3D - la couleur dit tout: paye, en attente, en retard, vacant. Suivi des loyers, rappels, documents et maintenance.',
			'rm_step1' => 'Ajoutez un bien', 'rm_step2' => 'Marquez vos appartements', 'rm_step3' => 'Tout en une couleur',
			'rm_cta' => 'Commencer, gratuit', 'rm_note' => 'Suivi et rappels, pas de paiement · prive, jamais indexe',
			...
			'm_tours' => 'Visites 3D', 'tours_all' => 'Toutes les visites — un seul endroit', 'tour_sd' => 'Visite du quartier Sde Dov', 'tour_so' => 'Visite du complexe Somail', 'tour_esd' => 'Hélicoptère Sde Dov — photo réelle', 'tour_eso' => 'Hélicoptère Somail', 'tour_des' => 'Design d’appartement', 'prices_index' => 'Prix des appartements — toutes les villes',
			'tour_catalog' => 'Le catalogue 3D', 'guides_all' => 'Tous les guides', 'nav_areas' => 'Zones en demande', 'nav_global' => 'Immobilier international',
			'cta_wa_b' => 'Plus de détails', 'cta_wa_s' => 'Réponse rapide sur WhatsApp', 'cta_wa_aria' => 'WhatsApp — plus de détails', 'cta_wa_msg' => 'Bonjour, je souhaite plus de détails.',
			...
			'rc_kicker' => 'De la plateforme', 'rc_title' => 'Bon a savoir', 'rc_term' => 'Terme du glossaire', 'rc_tool' => 'Calculateur', 'rc_guide' => 'Guide', 'rc_news' => 'Actualites', 'rc_calc_mortgage' => 'Calculateur hypothecaire', 'rc_calc_ptax' => 'Calculateur taxe d achat', 'rc_guide_buy' => 'Guide d achat', 'rc_dossier_k' => 'Contexte professionnel', 'rc_dossier_t' => 'Sur le domaine: l essentiel', 'sh_chip' => 'Le vrai modele 3D du projet', 'sh_spin' => 'Touchez pour faire pivoter en 3D', 'sh_floors' => 'etages', 'fl_kicker' => 'L experience complete', 'fl_title' => 'Choisissez votre appartement depuis le batiment, en 3D', 'fl_sub' => 'De vrais projets transformes en modeles vivants, en demonstration: pivotez le batiment, choisissez etage et orientation. Les promoteurs presentes ne sont pas nos clients - voici simplement a quoi ressemble un projet sur notre scene.', 'fl_dev' => 'Promoteurs: votre immeuble sur cette scene? Parlons-en', 'fl_all' => 'Catalogue 3D', 'fl_go' => 'Visiter le projet',
		...
		'ru' => array(
			...
			'trust_calc' => 'профессиональных калькулятора', 'trust_law' => 'юристы и специалисты в каталоге', 'trust_law_pre' => 'каталог:',
			'ur_kicker' => 'Городское обновление', 'ur_title' => 'Комната проекта вашего дома',
			'ur_sub' => 'Согласия каждой квартиры на 3D-модели дома, 10 этапов, документы и обновления - в одном приватном месте. Бесплатно для жильцов и комитета.',
			'ur_step1' => 'Проверьте дом', 'ur_step2' => 'Откройте комнату', 'ur_step3' => 'Пригласите соседей',
			'ur_cta1' => 'Бесплатная проверка', 'ur_cta2' => 'Комната проекта + живое демо',
			'ur_note' => 'Иврит · Английский · Русский · приватно, не в поиске',
			'rm_kicker' => 'Управление арендой · бесплатно', 'rm_title' => 'Каждая сдаваемая квартира: на карте, внутри здания',
			'rm_sub' => 'Добавьте объект, отметьте свои квартиры на 3D-модели - цвет говорит всё: оплачено, ожидает, просрочено, свободна. Учёт платежей, напоминания, документы и обслуживание.',
			'rm_step1' => 'Добавьте объект', 'rm_step2' => 'Отметьте квартиры на модели', 'rm_step3' => 'Всё в одном цвете',
			'rm_cta' => 'Начать бесплатно', 'rm_note' => 'Учёт и напоминания, без платежей · приватно, не в поиске',
			...
			'm_tours' => '3D-туры', 'tours_all' => 'Все туры — в одном месте', 'tour_sd' => 'Тур по кварталу Сде-Дов', 'tour_so' => 'Тур по комплексу Сомайль', 'tour_esd' => 'Вертолёт над Сде-Дов — реальная съёмка', 'tour_eso' => 'Вертолёт над Сомайль', 'tour_des' => 'Дизайн квартиры', 'prices_index' => 'Цены на квартиры — все города',
			'tour_catalog' => '3D-каталог', 'guides_all' => 'Все гиды', 'nav_areas' => 'Востребованные районы', 'nav_global' => 'Зарубежная недвижимость',
			'cta_wa_b' => 'Подробнее в WhatsApp', 'cta_wa_s' => 'Быстрый ответ в WhatsApp', 'cta_wa_aria' => 'WhatsApp — подробнее', 'cta_wa_msg' => 'Здравствуйте, хочу узнать подробнее.',
			...
			'rc_kicker' => 'От платформы', 'rc_title' => 'Полезно знать', 'rc_term' => 'Термин глоссария', 'rc_tool' => 'Калькулятор', 'rc_guide' => 'Гид', 'rc_news' => 'Новости', 'rc_calc_mortgage' => 'Ипотечный калькулятор', 'rc_calc_ptax' => 'Калькулятор налога', 'rc_guide_buy' => 'Гид покупателя', 'rc_dossier_k' => 'Профессиональный фон', 'rc_dossier_t' => 'О сфере: что важно знать', 'sh_chip' => 'Настоящая 3D модель проекта', 'sh_spin' => 'Нажмите чтобы вращать в 3D', 'sh_floors' => 'этажей', 'fl_kicker' => 'Полный опыт', 'fl_title' => 'Выберите квартиру изнутри здания, в 3D', 'fl_sub' => 'Реальные проекты, превращенные в живые модели как демонстрация возможностей: вращайте здание, выбирайте этаж и ориентацию. Показанные застройщики не являются нашими клиентами - именно так выглядит любой проект на нашей сцене.', 'fl_dev' => 'Застройщики: хотите свое здание на этой сцене? Свяжитесь с нами', 'fl_all' => '3D каталог', 'fl_go' => 'Тур по проекту',
		...
		'ar' => array(
			...
			'trust_calc' => 'حاسبات مهنية', 'trust_law' => 'محامون ومهنيون في الدليل', 'trust_law_pre' => 'دليل',
			'ur_kicker' => 'التجديد الحضري', 'ur_title' => 'غرفة مشروع مبناكم',
			'ur_sub' => 'متابعة موافقة كل شقة على نموذج ثلاثي الأبعاد، 10 مراحل، مستندات وتحديثات - في مكان خاص واحد. مجاني للسكان واللجنة.',
			'ur_step1' => 'افحصوا المبنى', 'ur_step2' => 'افتحوا غرفة', 'ur_step3' => 'ادعوا الجيران',
			'ur_cta1' => 'فحص جدوى مجاني', 'ur_cta2' => 'غرفة المشروع + عرض حي',
			'ur_note' => 'عبرية · إنجليزية · روسية · خاص ولا يظهر في البحث',
			'rm_kicker' => 'إدارة الإيجارات · مجانا', 'rm_title' => 'كل شقة مؤجرة: على الخريطة وداخل المبنى',
			'rm_sub' => 'أضيفوا عقارا، علموا شققكم على نموذج ثلاثي الأبعاد - اللون يقول كل شيء: مدفوع، معلق، متأخر، شاغرة. متابعة الدفعات، تذكيرات العقد والضريبة، مستندات وصيانة.',
			'rm_step1' => 'أضيفوا عقارا', 'rm_step2' => 'علموا الشقق على النموذج', 'rm_step3' => 'كل شيء بلون واحد',
			'rm_cta' => 'ابدأوا مجانا', 'rm_note' => 'متابعة وتذكيرات، بلا دفع · خاص ولا يظهر في البحث',
			...
			'm_tours' => 'جولات ثلاثية الأبعاد', 'tours_all' => 'كل الجولات — في مكان واحد', 'tour_sd' => 'جولة حي سديه دوف', 'tour_so' => 'جولة مجمع سوميل', 'tour_esd' => 'هليكوبتر سديه دوف — تصوير حقيقي', 'tour_eso' => 'هليكوبتر سوميل', 'tour_des' => 'مصمم الشقق', 'prices_index' => 'أسعار الشقق — كل المدن',
			'tour_catalog' => 'كتالوج ثلاثي الأبعاد', 'guides_all' => 'كل الأدلة', 'nav_areas' => 'مناطق الطلب', 'nav_global' => 'عقارات دولية',
			'cta_wa_b' => 'لمزيد من التفاصيل', 'cta_wa_s' => 'رد سريع على واتساب', 'cta_wa_aria' => 'واتساب — لمزيد من التفاصيل', 'cta_wa_msg' => 'مرحباً، أود المزيد من التفاصيل.',
			...
			'rc_kicker' => 'من المنصة', 'rc_title' => 'يستحق المعرفة', 'rc_term' => 'مصطلح', 'rc_tool' => 'حاسبة', 'rc_guide' => 'دليل', 'rc_news' => 'أخبار', 'rc_calc_mortgage' => 'حاسبة الرهن', 'rc_calc_ptax' => 'حاسبة ضريبة الشراء', 'rc_guide_buy' => 'دليل شراء شقة', 'rc_dossier_k' => 'خلفية مهنية', 'rc_dossier_t' => 'عن المجال: ما يهم معرفته', 'sh_chip' => 'نموذج ثلاثي الأبعاد حقيقي للمشروع', 'sh_spin' => 'انقروا للتدوير ثلاثي الأبعاد', 'sh_floors' => 'طوابق', 'fl_kicker' => 'التجربة الكاملة', 'fl_title' => 'اختاروا شقتكم من داخل المبنى، بتقنية ثلاثية الأبعاد', 'fl_sub' => 'مشاريع حقيقية حولناها إلى نماذج حية كعرض قدرات: دوروا المبنى واختاروا الطابق والاتجاه. المطورون المعروضون ليسوا عملاءنا - هكذا يبدو أي مشروع على منصتنا.', 'fl_dev' => 'مطورون: تريدون مبناكم على هذه المنصة؟ تحدثوا معنا', 'fl_all' => 'كتالوج ثلاثي الأبعاد', 'fl_go' => 'جولة في المشروع',
