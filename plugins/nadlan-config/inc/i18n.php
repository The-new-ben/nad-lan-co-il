...
if ( ! function_exists( 'nadlan_i18n_table' ) ) {
	function nadlan_i18n_table() {
		...
		'he' => array(
			...
			// areas band
			'ar_kicker' => 'אזורי ביקוש', 'ar_title' => 'לאן קונים מסתכלים עכשיו', 'ar_projects' => 'פרויקטים', 'ar_apts' => 'דירות',
			// magazine band
		...
		'en' => array(
			...
			'ar_kicker' => 'In-demand areas', 'ar_title' => 'Where buyers are looking now', 'ar_projects' => 'projects', 'ar_apts' => 'apartments',
		...
		'fr' => array(
			...
			'ar_kicker' => 'Zones prisées', 'ar_title' => 'Où regardent les acheteurs', 'ar_projects' => 'projets', 'ar_apts' => 'appartements',
		...
		'ru' => array(
			...
			'ar_kicker' => 'Востребованные районы', 'ar_title' => 'Куда смотрят покупатели сейчас', 'ar_projects' => 'проектов', 'ar_apts' => 'квартир',
		...
		'ar' => array(
			...
			'ar_kicker' => 'مناطق مطلوبة', 'ar_title' => 'أين ينظر المشترون الآن', 'ar_projects' => 'مشاريع', 'ar_apts' => 'شقق',
