...
if ( ! function_exists( 'nadlan_showroom_engine_shortcode' ) ) {
	function nadlan_showroom_engine_shortcode( $atts ) {
		...
		// assets
		wp_enqueue_style( 'nadlan-engine-tokens', $base . 'tokens.css', array(), '1.69.46' );
		wp_enqueue_style( 'nadlan-engine-css', $base . 'showroom.css', array( 'nadlan-engine-tokens' ), '1.69.46' );
		...
		wp_enqueue_script( 'nadlan-engine-i18n', $base . 'i18n.js', array(), '1.69.46', true );
		wp_enqueue_script( 'nadlan-engine-core', $base . 'engine.js', array( 'nadlan-engine-i18n' ), '1.69.46', true );
		...
		if ( (string) get_option( 'nadlan_mapbox_token', '' ) !== '' ) {
			...
			wp_enqueue_script( 'nadlan-engine-mapbox', $base . 'mapbox-init.js', array( 'nadlan-engine-core', 'mapbox-gl' ), '1.69.46', true );
		}
...
if ( ! function_exists( 'nadlan_showroom_engine_active_for' ) ) {
	function nadlan_showroom_engine_active_for( $post_id ) {
		...
		$default_on = apply_filters( 'nadlan_showroom_engine_default_on', array( 'ashira-sde-dov' ) );
