...
(function(){
	...
	function init(root){
		...
		scene.addEventListener('pointerdown',function(e){
			if(e.target.closest('button,a,input,.nlp3d-hotspot,.nlp3d-hotspot-hit,.nlp3d-model-viewer,.nlp3d-stage-card,.nlp3d-stage-viewframe')){return}
