...
if ( ! function_exists( 'nadlan_p3d_mobile_containment_v1665_css' ) ) {
	function nadlan_p3d_mobile_containment_v1665_css() {
		// v1.66.5: final mobile containment guard. Older mobile slices used
		// margin-inline:auto inside the theme column, which visually cropped the
		// showroom on 390px mobile even when scrollWidth stayed clean.
		return <<<'CSS'
@media(max-width:760px){.single-nadlan_project .entry-content>.nlp3d.nlp3d-premium,.single-nadlan_project .wp-block-post-content>.nlp3d.nlp3d-premium{box-sizing:border-box!important;position:relative!important;left:auto!important;right:auto!important;width:calc(100vw - 28px)!important;max-width:calc(100vw - 28px)!important;margin-left:calc(50% - 50vw + 14px)!important;margin-right:calc(50% - 50vw + 14px)!important;transform:none!important}.single-nadlan_project .entry-content>.nlp3d.nlp3d-premium.is-mobile-edge-fixed,.single-nadlan_project .wp-block-post-content>.nlp3d.nlp3d-premium.is-mobile-edge-fixed{transform:none!important}.nlp3d.nlp3d-premium.is-dual-showroom .nlp3d-stage-wrap{overflow:hidden!important}.nlp3d.nlp3d-premium.is-dual-showroom .nlp3d-scene{width:100%!important;max-width:100%!important}.nlp3d.nlp3d-premium.is-dual-showroom .nlp3d-facade-plane{right:10px!important;left:10px!important;width:auto!important;max-width:none!important}.nlp3d.nlp3d-premium.is-dual-showroom .nlp3d-fp-legend{right:12px!important;left:12px!important}}
CSS;
	}
}
...
add_action(
	...
	function () {
		...
		wp_register_style( 'nadlan-p3d', '', array(), '1.66.5' );
...
CSS
		...
		wp_add_inline_style( 'nadlan-p3d', nadlan_p3d_mobile_containment_v1665_css() );
		...
		wp_register_script( 'nadlan-p3d', '', array(), '1.66.5', true );
