...
<section class="nlp3d nlp3d-premium" dir="rtl" data-project="<?php echo esc_attr( $post_id ); ?>" aria-labelledby="<?php echo esc_attr( $uid ); ?>-title">
	...
	<div class="nlp3d-shell">
		...
		<div class="nlp3d-stage-wrap">
			...
			<div class="nlp3d-stage-card" aria-live="polite">
...
add_action(
	...
	function () {
		...
		wp_register_style( 'nadlan-p3d', '', array(), '1.61.0' );
		...
		wp_register_script( 'nadlan-p3d', '', array(), '1.61.0', true );
	...
	function () {
		...
		add_meta_box(
			...
			function ( $post ) {
				...
				echo '<p><label>יחידות JSON: id, title, floor, rooms, sqm, balcony, dir, line, view, price, price_estimate, status, plan<br><textarea name="project_3d_units" rows="10" class="widefat code">' . $js . '</textarea></label></p>';
...
add_filter(
	...
	function ( $out ) {
		...
		$out['project_3d'] = array(
			...
			'renderer'         => 'premium_tower_picker_v6_app_selector',
