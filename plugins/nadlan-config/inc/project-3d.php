...
if ( ! function_exists( 'nadlan_p3d_mobile_containment_v1667_css' ) ) {
	function nadlan_p3d_mobile_containment_v1667_css() {
		// v1.66.7: measured 390px phone correction. The theme's mobile column
		// starts the showroom at x=39.5 with width 362, so it needs a small
		// phone-only pull left. Tablet already passes and is intentionally left
		// untouched.
		return <<<'CSS'
@media(max-width:760px){.nlp3d.nlp3d-premium.is-dual-showroom .nlp3d-stage-wrap{overflow:hidden!important}.nlp3d.nlp3d-premium.is-dual-showroom .nlp3d-scene{width:100%!important;max-width:100%!important}.nlp3d.nlp3d-premium.is-dual-showroom .nlp3d-facade-plane{right:10px!important;left:10px!important;width:auto!important;max-width:none!important}.nlp3d.nlp3d-premium.is-dual-showroom .nlp3d-fp-legend{right:12px!important;left:12px!important}}@media(max-width:600px){.single-nadlan_project .entry-content>.nlp3d.nlp3d-premium,.single-nadlan_project .wp-block-post-content>.nlp3d.nlp3d-premium{box-sizing:border-box!important;position:relative!important;left:auto!important;right:auto!important;width:calc(100vw - 28px)!important;max-width:calc(100vw - 28px)!important;margin-left:-25px!important;margin-right:0!important;transform:none!important}.single-nadlan_project .entry-content>.nlp3d.nlp3d-premium.is-mobile-edge-fixed,.single-nadlan_project .wp-block-post-content>.nlp3d.nlp3d-premium.is-mobile-edge-fixed{left:auto!important;transform:none!important}}
CSS;
	}
}
...
add_action(
	...
	function () {
		...
		wp_register_style( 'nadlan-p3d', '', array(), '1.66.7' );
...
CSS
		...
		wp_add_inline_style( 'nadlan-p3d', nadlan_p3d_mobile_containment_v1667_css() );
		...
		wp_register_script( 'nadlan-p3d', '', array(), '1.66.7', true );
