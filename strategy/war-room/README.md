...
- `competitor-serp-source-map.csv` - structured current-source map for 14 competitor and reference surfaces.
...
- `current-site-evidence-2026-06-23.csv` - row-level summary of the fresh public screenshot run.
- `objective-completion-audit.csv` - requirement-by-requirement completion audit against the active objective.
...
This is not a final universe. It is the next executable slice after the recovered Report 2 package. Every future keyword, page, article, or Lovable prompt must respect:

- `../23-money-keyword-expansion-mandate.md`
- `../24-source-of-truth-cannibalization-system.md`
- `../04-keyword-master-universe.csv`
