// S1 — Homepage hero with full-bleed aerial photograph + dark glass search card.
...
export function HeroSection() {
  ...
  return (
    <section className="relative isolate overflow-hidden">
      <img
        src={heroImage}
        alt={isHe ? "צילום אווירי של קו החוף בתל אביב" : "Aerial view of the Tel Aviv shoreline"}
        width={1920}
        height={1088}
      ...
      <div className="mx-auto max-w-6xl px-4 py-24 sm:px-6 sm:py-32 lg:py-40">
        <div className="max-w-2xl rounded-2xl border border-white/10 bg-theater/70 p-6 text-paper backdrop-blur-md sm:p-8 stage-shadow">
          ...
          <h1 className="mt-4 text-paper" style={{ fontFamily: "var(--font-serif-he)" }}>
            {c.title}
          </h1>
            ...
            {c.tabs.map((tab, i) => (
              <button
                ...
                className={
                  ...
                  (activeTab === i
                    ? "bg-gold text-ink"
                    : "border border-paper/25 text-paper/85 hover:bg-paper/10")
                }
              >
                {tab}
              </button>
