...
| Recipe drift | `skills/recipe-flagship-project-page.md :: The shape`, `Related` | Active entry skill requires a `<1 MB` no-normal GLB and points to two absent canonical files |
