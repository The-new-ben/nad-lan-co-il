...
function nlpo_admin_page() {
	...
	<div class="wrap">
		...
		<p><?php esc_html_e( 'This screen checks the platform wiring without replacing the existing CMS, monetization, leads or showroom engine.', 'nadlan-platform-orchestrator' ); ?></p>
		<form method="post">
			...
			<table class="form-table" role="presentation">
				<tr>
					...
					<td><label><input type="checkbox" name="nlpo_auto_insert_home_band" value="1" <?php checked( get_option( 'nlpo_auto_insert_home_band', '0' ), '1' ); ?>> <?php esc_html_e( 'Append a project band to the homepage. Keep off until screenshot QA approves placement.', 'nadlan-platform-orchestrator' ); ?></label></td>
				</tr>
			</table>
