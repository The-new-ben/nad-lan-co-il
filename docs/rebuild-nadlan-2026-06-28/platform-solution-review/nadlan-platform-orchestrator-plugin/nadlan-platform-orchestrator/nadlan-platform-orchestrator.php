 ...
 * Description: Safe presentation and content orchestration layer for NadLan. Delegates showroom rendering to nadlan-config when present. Does not replace the CMS, billing, leads or existing engine.
 * Version: 0.1.0
 * Author: NadLan
...
add_filter( 'the_content', function ( $content ) {
	...
	if ( get_option( 'nlpo_auto_insert_home_band', '0' ) !== '1' ) {
		return $content;
	}
