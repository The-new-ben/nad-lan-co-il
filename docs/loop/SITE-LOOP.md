...
| R5 **next** | Rainbow interior at EcoCity level: our own Blender renders (360 cube maps per room, material variants), a viewer, rooms bar, plan, "view" to the real outside | todo | ecocity-cfg-teardown.md (coming), tech-stack.md |
